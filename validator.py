...
#----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if bankname.upper()=="CITI":
        ...
        login_elements_xpath=["//input[@id='User_Id']","//img[@id='skImg']","//div[@class='fl width189 pt5 pb10']//input[@id='password']","//div[@class='cl fl ls_login']"]
        try:
    ...
    if bankname.upper()=="CANARA":
        ...
        login_elements_xpath=["//input[@id='fldLoginUserId']","//input[@id='fldPassword']","//input[@class='btn btn-default']"]
        try:
            for elem in login_elements_xpath:
                if driver.find_element_by_xpath(elem).is_displayed():
                    pass
